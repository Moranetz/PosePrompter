...
const MODELS = [
  {
    ...
    name: 'Flux Pro',
    icon: Zap,
    description: 'Highest quality, photorealistic results. Auto-uses InstantID when face photo is selected.',
    quality: 5,
    recommended: true,
    supportsFacePhoto: true,
  },
  {
    id: PROVIDERS.INSTANTID,
    name: 'InstantID',
    icon: Sparkles,
    description: 'Face-preserving generation — keeps your face identity in any pose or style',
    quality: 5,
    recommended: false,
  ...
  },
  {
    ...
    name: 'SDXL',
    icon: ImageIcon,
    description: 'Fast and reliable. Uses IP-Adapter FaceID when face photo is selected.',
    quality: 4,
    recommended: false,
    supportsFacePhoto: true,
  },
  {
    ...
    name: 'DALL-E 3',
    icon: ImageIcon,
    description: 'OpenAI\'s advanced image model (text-to-image only, no face photo support)',
    quality: 5,
    recommended: false,
    supportsFacePhoto: false,
  },
];
