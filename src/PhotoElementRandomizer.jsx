...
const PhotoElementRandomizer = () => {
  ...
  const categories = {
    ...
    'BodyPose': [
      ...
      {
        id: "bodypose_014",
        title: "Casual Defiant Obscured Gaze",
        prompt: "Her pose is casual and almost defiant with her gaze partially obscured enhancing the mystery and focus on the raw rebellious energy of the moment.",
      },
      {
        id: "bodypose_015",
        title: "Leaning Confident Effortless Cool",
        prompt: "Leaning slightly outward with gaze direct and confident yet with a hint of something unsaid - relaxed posture conveying effortless cool.",
      },
      {
        id: "bodypose_016",
        title: "Playful Over-Shoulder Coquettish",
        prompt: "Her pose should be engaging and slightly coquettish looking directly at the viewer over her shoulder with an alluring yet innocent expression one hand playfully interacting with a nearby element.",
      },
      {
        id: "bodypose_017",
